...
class Auctions extends Component{
    ...
    render(){
        ...
        let auctionGrid = this.state.auctions.map(auction => <Auction userId={this.props.userId} hasher={this.props.hasher} type={this.props.type === "reveal" ? "reveal" : "bidding"} data={auction} getBidHash={this.props.getBidHash} placeBid={this.props.placeBid} revealBid={this.props.revealBid}/>)
        return(
