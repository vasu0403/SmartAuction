...
class App extends Component {
	...
	/**
	 * @notice used for revealing your auctual bid
	 * @param auctionId if of the auction for which bid is to be revealed
	 * @param bidValue acutal bid value
	 * @param publicKey key with which the bid was hashed
	 */
